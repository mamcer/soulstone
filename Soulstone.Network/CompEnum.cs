...
{
    public sealed class CompEnum : IEnumerable, IDisposable
    {
        ...
        public CompEnum(ServerType serverType, string domain)
            : this(UInt32.Parse(Enum.Format(typeof(ServerType), serverType, "x"), System.Globalization.NumberStyles.HexNumber), domain)
        {
